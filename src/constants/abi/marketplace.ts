...
implementation: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"implementation","type":"address"}>
}>;
...
export type FunctionDisabledEventFilters = Partial<{
  name: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"string","name":"name","type":"string"}>
functionSelector: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"bytes4","name":"functionSelector","type":"bytes4"}>
}>;
...
export type RoyaltyEngineUpdatedEventFilters = Partial<{
  previousAddress: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"previousAddress","type":"address"}>
newAddress: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"newAddress","type":"address"}>
}>;
...
export type CancelledListingEventFilters = Partial<{
  listingCreator: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"listingCreator","type":"address"}>
listingId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"listingId","type":"uint256"}>
}>;
...
export type CurrencyApprovedForListingEventFilters = Partial<{
  listingId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"listingId","type":"uint256"}>
currency: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"currency","type":"address"}>
}>;
...
export type NewListingEventFilters = Partial<{
  listingCreator: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"listingCreator","type":"address"}>
listingId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"listingId","type":"uint256"}>
assetContract: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"assetContract","type":"address"}>
}>;
...
assetContract: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"assetContract","type":"address"}>
closer: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"closer","type":"address"}>
}>;
...
export type CancelledAuctionEventFilters = Partial<{
  auctionCreator: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"auctionCreator","type":"address"}>
auctionId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"auctionId","type":"uint256"}>
}>;
...
export type NewBidEventFilters = Partial<{
  auctionId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"auctionId","type":"uint256"}>
bidder: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"bidder","type":"address"}>
assetContract: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"assetContract","type":"address"}>
}>;
...
export type AcceptedOfferEventFilters = Partial<{
  offeror: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"offeror","type":"address"}>
offerId: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"uint256","name":"offerId","type":"uint256"}>
assetContract: AbiParameterToPrimitiveType<{"indexed":true,"internalType":"address","name":"assetContract","type":"address"}>
}>;
...
export type GetImplementationForFunctionParams = {
  functionSelector: AbiParameterToPrimitiveType<{"internalType":"bytes4","name":"_functionSelector","type":"bytes4"}>
};
...
export type GetMetadataForFunctionParams = {
  functionSelector: AbiParameterToPrimitiveType<{"internalType":"bytes4","name":"functionSelector","type":"bytes4"}>
};
...
export type AddExtensionParams = {
  extension: AbiParameterToPrimitiveType<{"components":[{"components":[{"internalType":"string","name":"name","type":"string"},{"internalType":"string","name":"metadataURI","type":"string"},{"internalType":"address","name":"implementation","type":"address"}],"internalType":"struct IExtension.ExtensionMetadata","name":"metadata","type":"tuple"},{"components":[{"internalType":"bytes4","name":"functionSelector","type":"bytes4"},{"internalType":"string","name":"functionSignature","type":"string"}],"internalType":"struct IExtension.ExtensionFunction[]","name":"functions","type":"tuple[]"}],"internalType":"struct IExtension.Extension","name":"_extension","type":"tuple"}>
};
...
export type EnableFunctionInExtensionParams = {
  extensionName: AbiParameterToPrimitiveType<{"internalType":"string","name":"_extensionName","type":"string"}>
function: AbiParameterToPrimitiveType<{"components":[{"internalType":"bytes4","name":"functionSelector","type":"bytes4"},{"internalType":"string","name":"functionSignature","type":"string"}],"internalType":"struct IExtension.ExtensionFunction","name":"_function","type":"tuple"}>
};
...
export type SetRoyaltyEngineParams = {
  royaltyEngineAddress: AbiParameterToPrimitiveType<{"internalType":"address","name":"_royaltyEngineAddress","type":"address"}>
};
...
export type ApproveCurrencyForListingParams = {
  listingId: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"_listingId","type":"uint256"}>
currency: AbiParameterToPrimitiveType<{"internalType":"address","name":"_currency","type":"address"}>
pricePerTokenInCurrency: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"_pricePerTokenInCurrency","type":"uint256"}>
};
...
currency: AbiParameterToPrimitiveType<{"internalType":"address","name":"_currency","type":"address"}>
expectedTotalPrice: AbiParameterToPrimitiveType<{"internalType":"uint256","name":"_expectedTotalPrice","type":"uint256"}>
};
...
export type CreateListingParams = {
  params: AbiParameterToPrimitiveType<{"components":[{"internalType":"address","name":"assetContract","type":"address"},{"internalType":"uint256","name":"tokenId","type":"uint256"},{"internalType":"uint256","name":"quantity","type":"uint256"},{"internalType":"address","name":"currency","type":"address"},{"internalType":"uint256","name":"pricePerToken","type":"uint256"},{"internalType":"uint128","name":"startTimestamp","type":"uint128"},{"internalType":"uint128","name":"endTimestamp","type":"uint128"},{"internalType":"bool","name":"reserved","type":"bool"}],"internalType":"struct IDirectListings.ListingParameters","name":"_params","type":"tuple"}>
};
...
export type CreateAuctionParams = {
  params: AbiParameterToPrimitiveType<{"components":[{"internalType":"address","name":"assetContract","type":"address"},{"internalType":"uint256","name":"tokenId","type":"uint256"},{"internalType":"uint256","name":"quantity","type":"uint256"},{"internalType":"address","name":"currency","type":"address"},{"internalType":"uint256","name":"minimumBidAmount","type":"uint256"},{"internalType":"uint256","name":"buyoutBidAmount","type":"uint256"},{"internalType":"uint64","name":"timeBufferInSeconds","type":"uint64"},{"internalType":"uint64","name":"bidBufferBps","type":"uint64"},{"internalType":"uint64","name":"startTimestamp","type":"uint64"},{"internalType":"uint64","name":"endTimestamp","type":"uint64"}],"internalType":"struct IEnglishAuctions.AuctionParameters","name":"_params","type":"tuple"}>
};
