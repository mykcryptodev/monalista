...
function SquaresIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022 23.855 23.855 0 005.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0"
      />
    </svg>
  );
}
...
export function BottomNav() {
  ...
  return (
    <nav className="btm-nav bg-base-200/80 backdrop-blur-sm py-4 px-2 fixed bottom-0 inset-x-0 w-full mx-auto max-w-sm flex justify-around text-xs">
      ...
      <Link href="/theme" className={`flex flex-col items-center ${isActive("/theme") ? "active" : ""}`}> 
        <SwatchIcon />
